...
export const setSearchFields = actionCreator<{searchFields: ISearchField[]}>(SET_SEARCH_FIELDS)
export const setSortFields = actionCreator<{sortFields: ISortField[]}>(SET_SORT_FIELDS)
