...
const SET_CURRENT_GRID_VIEWER_IMAGE = "SET_CURRENT_GRID_VIEWER_IMAGE"
...
export const setCurrentGridViewerImage = actionCreator<{gridViewerImage: string}>(SET_CURRENT_GRID_VIEWER_IMAGE)
